...
async def check_usage(
    ...
    if user_id:
        ...
        try:
            ...
            # Use the higher count (stricter limit)
...
async def increment_usage(
    ...
    try:
        if user_id:
            ...
            # Increment both cookie and IP counters for anonymous
